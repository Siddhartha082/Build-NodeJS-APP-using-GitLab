...
```
cd existing_repo
git remote add origin https://gitlab.com/siddhartha082/nodejs_application.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/siddhartha082/nodejs_application/-/settings/integrations)
